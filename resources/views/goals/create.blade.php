...
<div class="text-center flex justify-center pt-10 bg-blue-100">
    ...
    <form id="form" class="bg-white w-1/3 border border-gray-400 rounded p-4 shadow-md mb-4" method="post"
        action="{{route('goals.store')}}">
        @csrf
        <div>
            <h1 class="p-2 text-xl">New Goal:</h1>
            <input class="w-full shadow-md border py-2 px-3" type="text" name="name" class="p-1"
                placeholder="New Goal" />
        </div>
        <div class="p-1">
            <h1 class="text-xl m-1 mt-3">Description</h1>
