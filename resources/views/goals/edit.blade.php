...
<div class="text-center flex justify-center">
    ...
    <form id="form" class="bg-gray-900 w-1/3 border-4 border-green-400 p-4 mb-4" method="post"
        ...
        @csrf
        <div>
            <h1 id="text-goal" class="p-2 text-xl text-green-400">Edit Goal:</h1>
            <input id="input-goal" class="w-full border-2 border-green-400 py-2 px-3 text-green-400 bg-gray-800"
                type="text" name="name" class="p-1" value="{{$goal->name}}" />
        </div>
        <div class="p-1">
            <h1 id="text-description" class="text-xl text-green-400 m-1 mt-3 ">Description</h1>
            <textarea id="input-description"
                class="w-full border-2 border-green-400 bg-gray-800 py-2 px-3 text-green-400" name="description"
                cols="30" rows="10" class="p-1">
            {{$goal->description}}
            </textarea>
        </div>
        ...
        <div class="p-1 mt-3">
            <input id="input-submit" type="submit"
                class="p-2 w-1/5 text-green-400 bg-gray-900 border-2 border-green-400 hover:bg-gray-800" value="Edit" />
        </div>
    </form>
</div>
